...
func TestCounter(t *testing.T) {
	...
	RunSpecs(t, "Counter Example Suite")
}
...
//
// It said 42 while the suite ran 53, in two places, one of them a table a
// reader is told to navigate by (QA-1's Phase 4 grading pass, F-5). The number
// was right when it was written and nothing read it afterwards, which is how
// every stale number in this repository got that way: the next author adds a
// spec, and prose does not notice.
//
